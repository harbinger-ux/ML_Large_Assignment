...
def train_and_evaluate_knn(train_dir, test_dir, use_hog=False, model_save_path=None):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train KNN for Traffic Sign Classification.")
    ...
    model_name = 'knn_hog_model.pkl' if args.hog else 'knn_raw_model.pkl'
    model_path = os.path.join(base_dir, 'models', model_name)
    
    os.makedirs(os.path.dirname(model_path), exist_ok=True)
    
    train_and_evaluate_knn(train_dir, test_dir, use_hog=args.hog, model_save_path=model_path)
